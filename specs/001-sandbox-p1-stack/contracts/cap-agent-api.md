...
**Date**: 2026-06-18
**Source**: [spec.md](../spec.md) FR-016, FR-017, FR-018, FR-019 · [data-model.md](../data-model.md) §3, §4, §6, §7 · `.archive/sandbox-design.md` §4.6, §4.8
...
- `.archive/sandbox-design.md` §4.6（cap-agent 职责）、§4.8（GUI 后端设计）
